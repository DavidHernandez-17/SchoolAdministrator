...
namespace SchoolAdministrator.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            {
                Subjects = await _combosHelper.GetComboSubjectsAsync(),
            };
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    return Json(new
                    {
                        ...
                        .Include(p => p.ProductImages)
                        .Include(p => p.ProductCategories)
                        .ThenInclude(pc => pc.Subject).ToList())
                    });
        ...
        public async Task<IActionResult> AddSubject(int? id)
        {
            ...
            AddSubjectProductViewModel model = new()
            {
                ProductId = product.Id,
                Subjects = await _combosHelper.GetComboSubjectsAsync(),
            };
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> AddSubject(AddSubjectProductViewModel model)
        {
            if (ModelState.IsValid)
            {
                Product product = await _context.Products.FindAsync(model.ProductId);
            ...
            return Json(new { isValid = false, html = ModalHelper.RenderRazorViewToString(this, "AddSubject", model) });
        }
